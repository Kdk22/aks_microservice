...
resource "azurerm_key_vault_access_policy" "example" {
  ...
  object_id    = module.ServicePrincipal.client_id
  ...
  depends_on = [ module.ServicePrincipal, module.keyvault ]
}
...
module "devops" {
  ...
  service_principal_id = module.ServicePrincipal.client_id
  service_principal_secret = module.ServicePrincipal.client_secret
