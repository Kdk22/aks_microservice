...
sudo usermod -aG docker aksproject
...
cd myagent
./config.sh --unattended --url https://dev.azure.com/utft0 --auth pat --token pibvctgpmeutdwsy7vfypwerewewewewewewecnf5ixknxgtwpcbiqn6eg5mlrchq --pool Default --agent aksagent --acceptTeeEula
